...
const en = {
  ...
  'kpi.byRole': 'By function (pallet vs picking)',
...
const pl: Record<TranslationKey, string> = {
  ...
  'kpi.byRole': 'Wg funkcji (paleta vs kompletacja)',
  'role.pallet': 'Miejsca paletowe',
  'role.pick': 'Kompletacja',
